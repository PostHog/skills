...
FROM
    (SELECT
        ...
        least(19, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-07-01 08:02:54.328323')), timestamp), greatest(1, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-07-01 08:02:54.328323')), toDateTime(toDateTime('2026-07-02 08:02:54.328893'))), 20)))) AS bin_idx,
        count() AS occ,
