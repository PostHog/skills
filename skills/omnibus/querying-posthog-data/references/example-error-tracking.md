...
FROM
    (SELECT
        ...
        least(19, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-07-25 10:48:48.350667')), timestamp), greatest(1, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-07-25 10:48:48.350667')), toDateTime(toDateTime('2026-07-26 10:48:48.350660'))), 20)))) AS bin_idx,
        count() AS occ,
