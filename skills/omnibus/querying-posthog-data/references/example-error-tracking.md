...
FROM
    (SELECT
        ...
        least(19, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-09-01 11:49:37.889917')), timestamp), greatest(1, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-09-01 11:49:37.889917')), toDateTime(toDateTime('2026-09-02 11:49:37.889888'))), 20)))) AS bin_idx,
        count() AS occ,
