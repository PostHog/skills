...
FROM
    (SELECT
        ...
        least(19, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-07-18 11:49:27.850410')), timestamp), greatest(1, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-07-18 11:49:27.850410')), toDateTime(toDateTime('2026-07-19 11:49:27.850403'))), 20)))) AS bin_idx,
        count() AS occ,
