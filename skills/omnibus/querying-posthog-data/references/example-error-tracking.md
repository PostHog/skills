...
FROM
    (SELECT
        ...
        least(19, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-09-18 12:00:00.000000')), timestamp), greatest(1, intDiv(dateDiff('seconds', toDateTime(toDateTime('2026-09-18 12:00:00.000000')), toDateTime(toDateTime('2026-09-19 12:06:32.931340'))), 20)))) AS bin_idx,
        count() AS occ,
