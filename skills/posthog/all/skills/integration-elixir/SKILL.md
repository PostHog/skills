...
# PostHog integration for Elixir

This skill helps you add PostHog analytics to Elixir applications.
...
- `references/EXAMPLE.md` - Elixir example project code
