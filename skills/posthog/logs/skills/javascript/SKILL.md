---
name: logs-javascript
description: PostHog logs for Web (JavaScript)
metadata:
  author: PostHog
  version: dev
---

# PostHog logs for Web (JavaScript)

This skill helps you add PostHog log ingestion to Web (JavaScript) applications.

## Reference files

- `references/javascript.md` - JavaScript web logs installation - docs
